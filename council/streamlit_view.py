...
from council.snapshot import build_live_snapshot
from council.council import council_decision, council_notes
...
def render_reports() -> None:
    """Show the honest backtest report + the rebuild meeting notes (from council/ files) in expanders."""
