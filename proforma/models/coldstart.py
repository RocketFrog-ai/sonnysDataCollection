...
HERE = Path(__file__).resolve().parent      # proforma/models
PROFORMA = HERE.parent                      # proforma
ART = PROFORMA / "artifacts"                # fitted here; refit in the env that loads it
CSV = PROFORMA / "data" / "panel" / "main-data-v2-stitched.csv"   # the shared, immutable panel
MODEL_PATH = ART / "coldstart (models 1-4)" / "coldstart_artifacts.joblib"
EARTH_KM = 6371.0088
H_DEFAULT = 60
