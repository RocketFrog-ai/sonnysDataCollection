...
see proforma/ui/app.py for the entrypoint and mode dispatch).
"""
...
HERE = Path(__file__).resolve().parents[1]  # panels/_shared.py -> proforma/ui (one dir deeper than app.py)
_PROFORMA = HERE.parent                     # proforma
CSV = _PROFORMA / "data" / "panel" / "main-data-v2-stitched.csv"
TYPES_CSV = _PROFORMA / "data" / "ref" / "site_carwash_types.csv"
ARTIFACTS = _PROFORMA / "artifacts"
EARTH_KM = 6371.0088
