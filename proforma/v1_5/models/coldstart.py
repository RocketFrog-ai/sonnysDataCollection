...
HERE = Path(__file__).resolve().parent      # proforma/v1_5/models
V1_5 = HERE.parent                          # proforma/v1_5
PROFORMA = HERE.parents[1]                  # proforma
ART = V1_5 / "artifacts"                    # version-owned: refit with this version's code
CSV = PROFORMA / "data" / "panel" / "main-data-v2-stitched.csv"   # version-shared, immutable
