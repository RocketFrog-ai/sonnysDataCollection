...
# The build table now lives once, in the shared data store. Kept as a candidate list because
# csv_path() returning None is a supported state: load_builds() falls back to baked medians.
_PROFORMA = Path(__file__).resolve().parents[2]   # proforma/
_CSV_CANDIDATES = [
    _PROFORMA / "data" / "ref" / "old-excel-proforma-data-enriched.csv",
]
