...
from app.site_analysis.modelling.ai.gas.config import (
...
from app.site_analysis.modelling.ai.gas.prompts import (
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Gas narrative debug runner")
    ...
    payload = {
        "quantile_result": {
            ...
            "predicted_wash_range": {"label": "140-175 washes/day"},
            "feature_analysis": {
                "nearest_gas_station_distance_miles": {
                    "value": 0.42,
                    "adjusted_percentile": 76.0,
                    "wash_correlated_q": 4,
                    "feature_quantile_adj": 4,
                    "dist_min": 0.2,
                    "dist_max": 0.55,
                    "category": "Strong",
                },
