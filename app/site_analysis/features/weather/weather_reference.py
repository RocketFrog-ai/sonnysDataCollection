...
Build precomputed JSON with: python -m app.site_analysis.features.weather.build_reference
"""
...
from app.site_analysis.features.weather.open_meteo import (
    get_climate_data_for_range,
    get_default_weather_range,
)
from app.site_analysis.features.weather.usa_states import (
