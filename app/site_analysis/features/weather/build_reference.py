...
if __name__ == "__main__":
    # four levels: features/weather/x.py -> features -> site_analysis -> app -> repo root
    sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "..")))

from app.site_analysis.features.weather.open_meteo import get_default_weather_range
from app.site_analysis.features.weather.weather_reference import (
    get_climate_data_for_state_bbox,
    get_usa_national_and_state_climate,
)
from app.site_analysis.features.weather.usa_states import STATE_BOUNDING_BOXES
