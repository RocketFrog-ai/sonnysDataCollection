...
# Allow running as script: the repo root must be on sys.path for the "app" package.
# app/site_analysis/features/<feature>/x.py -> four levels up is the repo root.
# (It used to go up three, landing on app/site_analysis, which never made `app` importable.)
