...
class PinpointForecastRequest(_PinRequest):
    ...
    pay_stations: Optional[str] = Field(None, description="Model 5 site input: accept the UI label ('3 or more') or the snake_case value ('3_or_more'); also accepts '1', '2', and 'live person'. All 4 site inputs together unlock the input-calibrated level; anything less falls back to pin-only.")
    vacuum_slots: Optional[str] = Field(None, description="Model 5 site input: accept the UI label ('12 - 20', 'more than 20', etc.) or the snake_case value ('12_to_20', 'more_than_20', etc.).")
    lot_type: Optional[str] = Field(None, description="Model 5 site input: accept the UI label ('corner lot with light', etc.) or the snake_case value ('corner_lot_with_light', etc.).")
