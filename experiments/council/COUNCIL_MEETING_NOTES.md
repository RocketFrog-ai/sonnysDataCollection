...
- A new **data signal seat** (`experiments/council/decider.py` over `experiments/council/features.py`) makes the go/no-go call — leakage-clean, honestly out-of-fold evaluated.
