...
- [ ] **Streamlit tab (proper).** v1 renders a live council section inline (`experiments/council/streamlit_view.py`,
      wired near the KPI charts in `proforma/ui/app.py`). Promote it to a real tab with an
...
- [ ] **Run the full N≈420** for stable numbers (`python -m experiments.council.harness`, ~1700 LLM calls), and once with
