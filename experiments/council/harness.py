...
actuals. Writes a per-(site×seat) CSV and an aggregate markdown report to experiments/council/outputs/.

Run:  python -m experiments.council.harness --limit 8       # cheap smoke over 8 sites
      python -m experiments.council.harness                  # full N≈492 (many LLM calls)
"""
...
from experiments.council.council import council_decision, SEATS
from experiments.council.scorer import realized_outcome, ape, gonogo_correct
