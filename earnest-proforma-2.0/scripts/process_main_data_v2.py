...
Run:  python earnest-proforma-2.0/scripts/process_main_data_v2.py
"""
import re
...
# v2 lives in both project data dirs (byte-identical); process each in place.
INPUTS = [
    "earnest-proforma-2.0/data/main-data-v2.csv",
    "earnest-proforma-final-1.6/data/main-data-v2.csv",
]
